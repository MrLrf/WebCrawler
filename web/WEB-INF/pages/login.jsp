...
<head>
    ...
    <!-- Animate.css -->
    <link href="<%=request.getContextPath()%>/asset/gentelella/vendors/animate.css/animate.min.css" rel="stylesheet">
        ...
        <div class="animate form login_form">
            <section class="login_content">
                <form>
                    ...
                    <div>
                        <a class="btn btn-default submit" href="/index.form">Log in</a>
        ...
        <div id="register" class="animate form registration_form">
            <section class="login_content">
                <form>
                    ...
                    <div>
                        <a class="btn btn-default submit" href="/index.form">Submit</a>
                    </div>
